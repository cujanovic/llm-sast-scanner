...
|-----------|-----------|
| **`llm-sast-scanner/`** | The core skill — a 7-step detection workflow plus Judge verification and an optional adversarial pass, backed by 93 vulnerability reference knowledge bases. |
...
93 reference knowledge bases, organized into categories:
