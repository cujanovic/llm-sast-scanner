...
current pass's analysis lens (see LOOP CONTROL), rather than all 101 at once. As the lens rotates across
...
pass's lens (not all 101 at once) to keep context cost bounded. Across all passes you MUST apply EVERY
